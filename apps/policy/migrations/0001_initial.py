    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', policy.models.ListField(default=[], verbose_name='策略项')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('policy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policy_relations', to='policy.Policy', verbose_name='策略编号')),
                ('policyset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policyset_relations', to='policy.PolicySet', verbose_name='策略集编号')),
            ],
            options={
                'verbose_name': '策略集映射',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hub', models.ForeignKey(db_column='hub_sn', on_delete=django.db.models.deletion.CASCADE, related_name='hub_send_down_policysets', to='equipment.Hub', verbose_name='集控编号')),
                ('policyset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='policyset_send_down_policysets', to='policy.PolicySet', verbose_name='策略集编号')),
            ],
            options={
                'verbose_name': '策略集下发',

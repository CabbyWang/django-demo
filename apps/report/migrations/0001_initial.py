    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hub', models.ForeignKey(db_column='hub_sn', on_delete=django.db.models.deletion.CASCADE, related_name='hub_consumption', to='equipment.Hub')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumption', models.DecimalField(decimal_places=1, max_digits=32)),
                ('date', models.DateField()),
                ('hub', models.ForeignKey(db_column='hub_sn', on_delete=django.db.models.deletion.CASCADE, related_name='hub_lampctrlconsumption', to='equipment.Hub')),

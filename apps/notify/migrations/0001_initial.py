    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurred_time', models.DateTimeField(default=datetime.datetime.now, help_text='发生时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='alert_audio', to='notify.Alert', verbose_name='告警编号')),
            ],
            options={
                'verbose_name': '告警语音',

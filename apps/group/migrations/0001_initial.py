    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hub', models.ForeignKey(db_column='hub_sn', help_text='集控编号', on_delete=django.db.models.deletion.CASCADE, related_name='hub_group', to='equipment.Hub')),
                ('lampctrl', models.ForeignKey(db_column='lampctrl_sn', help_text='灯控编号', on_delete=django.db.models.deletion.CASCADE, related_name='lampctrl_group', to='equipment.LampCtrl')),
            ],
            options={
                'verbose_name': '灯控分组',
